...
const skills: Skill[] = [
  ...
  { name: "Tailwind CSS", icon: <SiTailwindcss size={28} />, top: "70%", left: "60%" },

  // Backend
  { name: "Spring Boot", icon: <SiSpringboot size={28} />, top: "42%", left: "72%" },
  ...
  { name: "PostgreSQL", icon: <SiPostgresql size={28} />, top: "72%", left: "78%" },
  ...
  // Architecture
  { name: "Apache Kafka", icon: <SiApachekafka size={28} />, top: "10%", left: "88%" },
  { name: "System Design", icon: <TbApi size={28} />, top: "90%", left: "38%" },
  { name: "Design Patterns", icon: <TbApi size={28} />, top: "65%", left: "40%" },
  { name: "DSA", icon: <TbApi size={28} />, top: "45%", left: "90%" },
  { name: "Event-Driven", icon: <TbApi size={28} />, top: "92%", left: "70%" },
];
...
const Skills: React.FC = () => {
  return (
    <section className="py-20 text-white relative">
      ...
      <div className="relative max-w-6xl mx-auto h-[700px] md:h-[750px] overflow-hidden">
